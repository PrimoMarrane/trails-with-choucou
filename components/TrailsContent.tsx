...
import type { TrailListItem } from '@/lib/data';
...
interface Props {
  initialTrails: TrailListItem[];
}

export default function TrailsContent({ initialTrails }: Props) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1">
            <TrailFilters onFilterChange={handleFilterChange} />
          </div>
          ...
          <div className="lg:col-span-3">
            {loading ? (
              ...
              <div
                key="map-view"
                className="h-[calc(100vh-300px)] rounded-lg overflow-hidden shadow-lg"
              >
                <MapView
                  trails={trails}
                  onTrailClick={(id) => {
